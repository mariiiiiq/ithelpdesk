          ...
          <?php
              if(isset($_GET['msg'])){
                ...
                if($msg == "changedpass"){
                  ...
                  echo "<a href='logsEquipAdmin.php' class='close'> <span aria-hidden='true'>&times;</span></a></div>";
                }
              ...
              <div class="col-lg-20 mb-4">
                <div class="card">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM tbllogs where module='Equipment' order by date DESC, time DESC";
