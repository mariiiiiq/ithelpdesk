          ...
          <?php
              if(isset($_GET['msg'])){
                ...
                if($msg == "changedpass"){
                  ...
                  echo "<a href='logsTicketTech.php' class='close'> <span aria-hidden='true'>&times;</span></a></div>";
                }
              ...
              <div class="col-lg-20 mb-4">
                <div class="card">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM tbllogs where module='Ticket' and user = '".$_SESSION['account']."' order by date DESC, time DESC";
