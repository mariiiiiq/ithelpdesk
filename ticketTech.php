    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3 bg-dark">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="equipTech.php" class="sidebar-link text-muted"><i class="o-computer-display-1 mr-3 text-gray"></i><span>Equipment</span></a></li>
              <li class="sidebar-list-item"><a href="ticketTech.php" class="sidebar-link text-muted active"><i class="o-paper-stack-1 mr-3 text-gray"></i><span>Ticket</span></a></li>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        ...
        <section>
            ...
            <a href="logsTicketTech.php" class="btn btn-info">Logs</a>
            <a href="ticketTech.php" class="btn btn-warning">Refresh</a>
            </div>
            <?php
              if(isset($_GET['msg'])){
                $msg = $_GET['msg'];
                ...
                if($msg == "changedpass"){
                  ...
                  echo "<a href='ticketTech.php' class='close'> <span aria-hidden='true'>&times;</span></a></div>";
                }
                elseif($msg == "ticketComplete"){
              ...
              <div class="col-lg-12 mb-4">
                <div class="card">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM tblticket WHERE assignedTo='".$_SESSION['account']."' order by date DESC, time DESC";
                  ...
                  ?>
                        <div class="card-body">   
                          ...
                          <table class="table table-hover card-text">
                            ...
                            ?>
                                <td> 
                                <form action="processTechTicket.php" method="post">
                                <a href="#view<?php echo $ticketid;?>" data-toggle="modal" class="btn btn-primary">View</a>
                                <?php
                                if($row['status'] == "On-going"){
                                  ?>
                                    <input type="submit" name="btnComplete" value="Complete" class="btn btn-success">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <div class="form-group">
                                        ...
                                        <label>Approved By: <?php echo $row['approvedBy'] ;?></label><br>
        ...
        <div class="modal fade" id="changePass" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                      <form action = "processTechTicket.php" method="post" name="pass"onsubmit="return password()">
                          <div class="form-group">
