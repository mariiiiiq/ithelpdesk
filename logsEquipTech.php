          ...
          <?php
              if(isset($_GET['msg'])){
                ...
                if($msg == "changedpass"){
                  ...
                  echo "<a href='logsEquipTech.php' class='close'> <span aria-hidden='true'>&times;</span></a></div>";
                }
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="form-group">
                      <center><h2 class="text-primary">Equipment Logs</h2></center>
                    </div>
                  </div>
                  <?php
                    require_once "config.php";
                    $sql = "SELECT * FROM tbllogs where module='Equipment' and user = '".$_SESSION['account']."' order by date DESC, time DESC";
                  ...
                  ?>
                        <div class="card-body">   
                          ...
                          <table class="table table-hover card-text">
                            ...
                            ?>
                               <td> <a href="#delete<?php echo $row['id'];?>" data-toggle="modal" class="btn btn-danger">Delete</a></td>
                              </tr>
                               <!-- Delete Modal -->
