          ...
          <?php
              if(isset($_GET['msg'])){
                ...
                if($msg == "changedpass"){
                  ...
                  echo "<a href='logsAcc.php' class='close'> <span aria-hidden='true'>&times;</span></a></div>";
                }
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="form-group">
                      <center><h2 class="text-primary">Account Logs</h2></center>
                    </div>
                  </div>
                  <?php
                    require_once "config.php";
                    $sql = "SELECT * FROM tbllogs where module='Account' order by date DESC, time DESC";
