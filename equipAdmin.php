    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3 bg-dark">
        ...
        <li class="sidebar-list-item"><a href="account.php" class="sidebar-link text-muted"><i class="o-profile-1 mr-3 text-gray"></i><span>Accounts</span></a></li>
              <li class="sidebar-list-item"><a href="equipAdmin.php" class="sidebar-link text-muted active"><i class="o-computer-display-1 mr-3 text-gray"></i><span>Equipment</span></a></li>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
          <section>
            ...
            <a href="logsEquipAdmin.php" class="btn btn-info">Logs</a>
            <a href="equipAdmin.php" class="btn btn-warning">Refresh</a>
            </div>
            <br>
            <?php
              if(isset($_GET['msg'])){
                ...
                if($msg == "changedpass"){
                  ...
                  echo "<a href='equipAdmin.php' class='close'> <span aria-hidden='true'>&times;</span></a></div>";
                }
                              ...
                              <div class="modal fade" id="edit<?php echo $assetno?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                    <form action="processAdminEquip.php" method="post" id="editEquip">
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <div class="modal-body">
                                      <div class="form-group">
                                      <form action = "processAdminEquip.php" method="post">
          ...
          <div class="modal fade" id="AddEquipment" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="addEquipmentLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form action = "processAdminEquip.php" method="post" id="addEquipment" name="add" onsubmit="return blank()">
                  <div class="form-group">
                    <label>Serial Number:</label>
        ...
        <div class="modal fade" id="changePass" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                      <form action = "processAdminEquip.php" method="post" name="pass" onsubmit="return password()">
                          <div class="form-group">
...
window.location.href = "equipAdmin.php";
});
}
